        ...
        <div id="<?php echo get_the_ID(); ?>" class="white-popup mfp-with-anim">
          <div class="portfolio-nav-inner">
            <div class="pull-right">
                <a href="<?php echo esc_url(home_url()); ?>" class="mfp-close close back_linc">Back</a>
            </div>
                        ...
                        <div class="col-md-12">
                          <div class="arrow-left">
                            ...
                            if($next_post_url != "no-posts"){ ?>
                                <a href="<?php echo esc_url($next_post_url); ?>"><i class="fa fa-angle-left"></i></a>
                            <?php } ?>
...
<hr>
                            ...
                            ?>
                                ...
                                <?php if(!empty($date)){ ?>
                                        ...
                                        <i class="fa fa-clock-o"></i>&nbsp;<?php echo esc_attr($date); ?>&nbsp;&nbsp;&nbsp;&nbsp;

                                <?php }
                                if(!empty($client)){ ?>

                                        <i class="fa fa-bolt"></i>&nbsp;<?php echo esc_attr($client); ?>
