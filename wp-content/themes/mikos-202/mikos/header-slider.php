    ...
    <div id="home">
        ...
        <div id="slides">
                ...
                <div class="slides-container">
                    ...
                    while ( have_rows('slider_version') ) : the_row();
                        ...
                        <div>
                            ...
                            <div class="overlay">
                                <div class="bnr-text"><hr class="wow fadeInUp animated" data-wow-duration="2s" data-wow-delay="0.6s" style="visibility: visible; animation-duration: 0.8s; animation-delay: 0.6s; animation-name: fadeInUp;">
                                    <?php
                                    ...
                                    if(!empty($large_heading)){
                                        ...
                                        $delay = 1;
                                        ?><hr class="wow fadeInDown animated" data-wow-duration="2s" data-wow-delay="0.6s" style="visibility: visible; animation-duration: 0.8s; animation-delay: 0.6s; animation-name: fadeInDown;"><div>  <?php
            ...
            if($show_scroll_button == 1){ ?>
                <div class="scroll"> <a href="#<?php echo esc_attr($scroll_link); ?>" class="go-down scrollDown-animate"></a> </div>
            <?php } ?>
        </div>
    </div>
    <!--HEADER-->
