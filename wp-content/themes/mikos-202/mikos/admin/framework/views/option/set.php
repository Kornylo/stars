...
$url_vaf_framework = 'vafpress.com/vafpress-framework';
$url_vaf_framework_next = 'vafpress.com';
...
<div class="wrap">
	...
	<div id="vp-wrap" class="vp-wrap">
			...
			<div class="vp-right-panel">
				<form id="vp-option-form" class="vp-option-form vp-js-option-form" method="POST">
					<div id="vp-submit-top" class="vp-submit top">
						<div class="inner">
							<input class="vp-save vp-button button button-primary" type="submit" value="<?php esc_html_e('Save Changes', 'mikos'); ?>" />
							<p class="vp-js-save-loader save-loader" style="display: none;"><img src="<?php VP_Util_Res::img_out('ajax-loader.gif', ''); ?>" /><?php esc_html_e('Saving Now', 'mikos'); ?></p>
		...
		<div id="vp-copyright" class="vp-copyright">
			<p><?php printf( esc_html__('This option panel is built using %s powered by %s', 'mikos'), '<a href="' . esc_url( $url_vaf_framework ) . '">Vafpress Framework ' . VP_VERSION . '</a>', '<a href="' . esc_url( $url_vaf_framework_next ) . '">Vafpress</a>'); ?></p>
		</div>
	</div>
</div>