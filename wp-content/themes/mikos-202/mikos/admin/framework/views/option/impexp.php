<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php esc_html_e('Import', 'mikos') ?>
		</label>
		<div class="description">
			<p><?php esc_html_e('Import Options', 'mikos') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-import" class="vp-button button" type="button" value="<?php esc_html_e('Import', 'mikos') ?>" />
...
<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php esc_html_e('Export', 'mikos') ?>
		</label>
		<div class="description">
			<p><?php esc_html_e('Export Options', 'mikos') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-export" class="vp-button button" type="button" value="<?php esc_html_e('Export', 'mikos') ?>" />
				<span style="margin-left: 10px;">
