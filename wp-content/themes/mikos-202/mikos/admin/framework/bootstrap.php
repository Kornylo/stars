...
// Include Constants    //
//////////////////////////
require_once get_template_directory() . '/admin/framework/constant.php';
//////////////////////////
// Include Autoloader   //
//////////////////////////
require_once get_template_directory() . '/admin/framework/autoload.php';
//////////////////////////
// Load Languages       //
//////////////////////////
load_theme_textdomain('mikos', VP_DIR . '/lang');
//////////////////////////
// Setup FileSystem     //
//////////////////////////
...
if( !function_exists('vp_ajax_wrapper') )
{
	function vp_ajax_wrapper()
	{
		...
		else
		{
			$result['data']    = '';
			$result['status']  = false;
			$result['message'] = esc_html__("Unauthorized function", 'mikos');
		}
