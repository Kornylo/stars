...
$error_field_type = '<b>' . esc_html__('Error', 'mikos') . '</b> ' . esc_html__('Field type does not exist', 'mikos');
	...
	<table class="acf widefat">
		<thead>
			<tr>
				...
				<th class="field_key"><?php esc_html_e('Field Key','mikos'); ?></th>
			</tr>
		</thead>
	</table>
</div>
...
<div class="fields">
	...
	<div class="no_fields_message" <?php if(count($fields) > 1){ echo 'style="display:none;"'; } ?>>
		<?php esc_html_e("No fields. Click the <strong>+ Add Field</strong> button to create your first field.",'mikos'); ?>
	</div>
	<!-- / No Fields Message -->
			...
			<table class="acf widefat">
				<tr>
					...
					<td class="field_label">
						<strong>
							<a class="acf_edit_field row-title" title="<?php esc_html_e("Edit this Field",'mikos'); ?>" href="javascript:;"><?php echo $field['label']; ?></a>
						</strong>
						<div class="row_options">
							...
							<span><a title="<?php esc_html_e("Read documentation for this field",'mikos'); ?>" href="http://www.advancedcustomfields.com/resources/#field-types" target="_blank"><?php esc_html_e("Docs",'mikos'); ?></a> | </span>
							...
							<span><a class="acf_delete_field" title="<?php esc_html_e("Delete this Field",'mikos'); ?>" href="javascript:;"><?php esc_html_e("Delete",'mikos'); ?></a></span>
						</div>
					</td>
				...
				<table class="acf_input widefat acf_field_form_table">
					<tbody>
						<tr class="field_label">
							<td class="label">
								<label><?php esc_html_e("Field Label",'mikos'); ?><span class="required">*</span></label>
						...
						<tr class="field_name">
							<td class="label">
								<label><?php esc_html_e("Field Name",'mikos'); ?><span class="required">*</span></label>
						...
						<tr class="field_type">
							<td class="label">
								<label><?php esc_html_e("Field Type",'mikos'); ?><span class="required">*</span></label>
							</td>
							<td>
								<?php
								do_action('acf/create_field', array(
						...
						<tr class="field_instructions">
							<td class="label"><label><?php esc_html_e("Field Instructions",'mikos'); ?></label>
							<p class="description"><?php esc_html_e("Instructions for authors. Shown when submitting data",'mikos'); ?></p></td>
							<td>
								<?php 
								do_action('acf/create_field', array(
									'type'	=>	'textarea',
						...
						<tr class="required">
							<td class="label"><label><?php esc_html_e("Required?",'mikos'); ?></label></td>
							<td>
								<?php 
								do_action('acf/create_field', array(
									'type'	=>	'radio',
									...
									'choices'	=>	array(
										1	=>	esc_html__("Yes",'mikos'),
										0	=>	esc_html__("No",'mikos'),
									),
									'layout'	=>	'horizontal',
								));
								?>
						...
						<tr class="conditional-logic" data-field_name="<?php echo $field['key']; ?>">
							<td class="label"><label><?php esc_html_e("Conditional Logic",'mikos'); ?></label></td>
							<td>
								<?php 
								do_action('acf/create_field', array(
									'type'	=>	'radio',
								...
								<div class="contional-logic-rules-wrapper" <?php if( ! $field['conditional_logic']['status'] ) echo 'style="display:none"'; ?>>
									...
									<ul class="hl clearfix">
										<li style="padding:4px 4px 0 0;"><?php esc_html_e("Show this field when",'mikos'); ?></li>
										<li><?php do_action('acf/create_field', array(
												...
												'choices' => array(
													'all'	=>	esc_html__("all",'mikos'),
													'any'	=>	esc_html__("any",'mikos'),
												),
										)); ?></li>
										<li style="padding:4px 0 0 4px;"><?php esc_html_e("these rules are met",'mikos'); ?></li>
									</ul>
						...
						<tr class="field_save">
							...
							<td>
								<ul class="hl clearfix">
									<li>
										<a class="acf_edit_field acf-button grey" title="<?php esc_html_e("Close Field",'mikos'); ?>" href="javascript:;"><?php esc_html_e("Close Field",'mikos'); ?></a>
									</li>
								</ul>
							</td>
						</tr>
...
<div class="table_footer">
	...
	<a href="javascript:;" id="add_field" class="acf-button"><?php esc_html_e('+ Add Field','mikos'); ?></a>
</div>