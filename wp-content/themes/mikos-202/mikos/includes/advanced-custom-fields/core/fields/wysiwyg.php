...
class acf_field_wysiwyg extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'wysiwyg';
		$this->label = esc_html__("Wysiwyg Editor",'mikos');
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php esc_html_e("Toolbar",'mikos'); ?></label>
	</td>
	<td>
		<?php
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php esc_html_e("Show Media Upload Buttons?",'mikos'); ?></label>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices' => array(
				'yes'	=>	esc_html__("Yes",'mikos'),
				'no'	=>	esc_html__("No",'mikos'),
			)
		));
		?>
	</td>
