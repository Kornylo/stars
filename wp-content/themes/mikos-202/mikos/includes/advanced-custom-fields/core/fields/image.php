...
class acf_field_image extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'image';
		$this->label = esc_html__("Image",'mikos');
		...
		$this->l10n = array(
			'select'		=>	esc_html__("Select Image",'mikos'),
			'edit'			=>	esc_html__("Edit Image",'mikos'),
			'update'		=>	esc_html__("Update Image",'mikos'),
			'uploadedTo'	=>	esc_html__("uploaded to this post",'mikos'),
		);
...
<div class="acf-image-uploader clearfix <?php echo $o['class']; ?>" data-preview_size="<?php echo $field['preview_size']; ?>" data-library="<?php echo $field['library']; ?>" >
	...
	<div class="has-image">
		<div class="hover">
			<ul class="bl">
				<li><a class="acf-button-delete ir" href="#"><?php esc_html_e("Remove",'mikos'); ?></a></li>
				<li><a class="acf-button-edit ir" href="#"><?php esc_html_e("Edit",'mikos'); ?></a></li>
			</ul>
		</div>
		<img class="acf-image-image" src="<?php echo $o['url']; ?>" alt=""/>
	</div>
	<div class="no-image">
		<p><?php esc_html_e('No image selected','mikos'); ?> <input type="button" class="button add-image" value="<?php esc_html_e('Add Image','mikos'); ?>" />
	</div>
</div>
		<?php
	}
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php esc_html_e("Return Value",'mikos'); ?></label>
		<p><?php esc_html_e("Specify the returned value on front end",'mikos') ?></p>
	</td>
	<td>
		<?php
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices'	=> array(
				'object'	=>	esc_html__("Image Object",'mikos'),
				'url'		=>	esc_html__("Image URL",'mikos'),
				'id'		=>	esc_html__("Image ID",'mikos')
			)
		));
		?>
	</td>
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		...
		<p><?php esc_html_e("Shown when entering data",'mikos') ?></p>
	</td>
	<td>
		<?php
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php esc_html_e("Library",'mikos'); ?></label>
		<p><?php esc_html_e("Limit the media library choice",'mikos') ?></p>
	</td>
	<td>
		<?php
		...
		do_action('acf/create_field', array(
			...
			'choices' 	=>	array(
				...
				'uploadedTo' => esc_html__('Uploaded to post', 'mikos')
			)
		));
		?>
	</td>
