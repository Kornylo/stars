...
class acf_field_radio extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'radio';
		$this->label = esc_html__("Radio Button",'mikos');
		$this->category = esc_html__("Choice",'mikos');
		$this->defaults = array(
			'layout'			=>	'vertical',
			'choices'			=>	array(),
			'default_value'		=>	'',
	...
	*/
	...
	function create_field( $field )
	{
		...
		if( $field['other_choice'] )
		{
			...
			$e .= '<li><label><input id="' . esc_attr($field['id']) . '-other" type="radio" name="' . esc_attr($field['name']) . '" value="other" ' . $atts . ' />' . esc_html__("Other", 'mikos') . '</label> <input type="text" ' . $atts2 . ' /></li>';
		}
		$e .= '</ul>';
	...
	*/
	...
	function create_options( $field )
	{
		...
		<tr class="field_option field_option_<?php echo $this->name; ?>">
			<td class="label">
				<label for=""><?php esc_html_e("Choices",'mikos'); ?></label>
				<p class="description"><?php esc_html_e("Enter your choices one per line",'mikos'); ?><br />
				<br />
				<?php esc_html_e("Red",'mikos'); ?><br />
				<?php esc_html_e("Blue",'mikos'); ?><br />
				<br />
				<?php esc_html_e("red : Red",'mikos'); ?><br />
				<?php esc_html_e("blue : Blue",'mikos'); ?><br />
				</p>
			</td>
			<td>
				<?php
				...
				do_action('acf/create_field', array(
					...
					'message'	=>	esc_html__("Add 'other' choice to allow for custom values", 'mikos')
				));
				...
				do_action('acf/create_field', array(
					...
					'message'	=>	esc_html__("Save 'other' values to the field's choices", 'mikos')
				));
		...
		<tr class="field_option field_option_<?php echo $this->name; ?>">
			<td class="label">
				<label><?php esc_html_e("Default Value",'mikos'); ?></label>
			</td>
			<td>
				<?php
		...
		<tr class="field_option field_option_<?php echo $this->name; ?>">
			<td class="label">
				<label for=""><?php esc_html_e("Layout",'mikos'); ?></label>
			</td>
			<td>
				<?php
				...
				do_action('acf/create_field', array(
					...
					'layout' => 'horizontal', 
					'choices' => array(
						'vertical' => esc_html__("Vertical",'mikos'),
						'horizontal' => esc_html__("Horizontal",'mikos')
					)
				));
