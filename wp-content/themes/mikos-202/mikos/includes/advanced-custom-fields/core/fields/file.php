...
class acf_field_file extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'file';
		$this->label = esc_html__("File",'mikos');
		...
		$this->l10n = array(
			'select'		=>	esc_html__("Select File",'mikos'),
			'edit'			=>	esc_html__("Edit File",'mikos'),
			'update'		=>	esc_html__("Update File",'mikos'),
...
<div class="acf-file-uploader clearfix <?php echo $o['class']; ?>" data-library="<?php echo $field['library']; ?>">
	...
	<div class="has-file">
		<ul class="hl clearfix">
			...
			<li>
				...
				<p>
					<strong><?php esc_html_e('Name', 'mikos'); ?>:</strong>
					<a class="acf-file-name" href="<?php echo $o['url']; ?>" target="_blank"><?php echo $o['name']; ?></a>
				</p>
				<p>
					<strong><?php esc_html_e('Size', 'mikos'); ?>:</strong>
	...
	<div class="no-file">
		<ul class="hl clearfix">
			<li>
				<span><?php esc_html_e('No File Selected','mikos'); ?></span>. <a href="#" class="button add-file"><?php esc_html_e('Add File','mikos'); ?></a>
			</li>
		</ul>
	</div>
</div>
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	...
	<td>
		...
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices' 	=>	array(
				'object'	=>	esc_html__("File Object",'mikos'),
				'url'		=>	esc_html__("File URL",'mikos'),
				'id'		=>	esc_html__("File ID",'mikos')
			)
		));
