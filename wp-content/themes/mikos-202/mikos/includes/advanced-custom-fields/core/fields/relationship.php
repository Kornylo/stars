...
class acf_field_relationship extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		...
		$this->label = esc_html__("Relationship",'mikos');
		$this->category = esc_html__("Relational",'mikos');
		$this->defaults = array(
			'post_type'			=>	array('all'),
			'max' 				=>	'',
			'taxonomy' 			=>	array('all'),
		...
		$this->l10n = array(
			'max'		=> esc_html__("Maximum values reached ( {max} values )",'mikos'),
			'tmpl_li'	=> '
							<li>
	...
	<div class="relationship_left">
		<table class="widefat">
			<thead>
				...
				<tr>
					<th>
						<input class="relationship_search" placeholder="<?php esc_html_e("Search...",'mikos'); ?>" type="text" id="relationship_<?php echo $field['name']; ?>" />
					</th>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<th>
						...
						// vars
						$choices = array(
							'all' => esc_html__("Filter by post type",'mikos')
						);
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php esc_html_e("Return Format",'mikos'); ?></label>
	...
	<td>
		...
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices'	=> array(
				'object'	=>	esc_html__("Post Objects",'mikos'),
				'id'		=>	esc_html__("Post IDs",'mikos')
			)
		));
		?>
	</td>
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label for=""><?php esc_html_e("Post Type",'mikos'); ?></label>
	</td>
	<td>
		<?php 
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php esc_html_e("Filter from Taxonomy",'mikos'); ?></label>
	</td>
	<td>
		<?php 
		$choices = array(
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php esc_html_e("Filters",'mikos'); ?></label>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
			...
			'value'	=>	$field['filters'],
			'choices'	=>	array(
				'search'	=>	esc_html__("Search",'mikos'),
				'post_type'	=>	esc_html__("Post Type Select",'mikos'),
			)
		));
		?>
	</td>
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php esc_html_e("Elements",'mikos'); ?></label>
		<p><?php esc_html_e("Selected elements will be displayed in each result",'mikos') ?></p>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
			...
			'choices' => array(
				...
				'post_title' => esc_html__("Post Title",'mikos'),
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php esc_html_e("Maximum posts",'mikos'); ?></label>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
