...
class acf_field_select extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'select';
		$this->label = esc_html__("Select",'mikos');
	...
	*/
	...
	function create_field( $field )
	{
		...
		if( $field['allow_null'] )
		{
			echo '<option value="null">- ' . esc_html__("Select",'mikos') . ' -</option>';
		}
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		...
		<p><?php esc_html_e("Enter each choice on a new line.",'mikos'); ?></p>
		<p><?php esc_html_e("For more control, you may specify both a value and label like this:",'mikos'); ?></p>
		<p><?php esc_html_e("red : Red",'mikos'); ?><br /><?php esc_html_e("blue : Blue",'mikos'); ?></p>
	</td>
	<td>
		<?php
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		...
		<p class="description"><?php esc_html_e("Enter each default value on a new line",'mikos'); ?></p>
	</td>
	<td>
		<?php
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php esc_html_e("Select multiple values?",'mikos'); ?></label>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
