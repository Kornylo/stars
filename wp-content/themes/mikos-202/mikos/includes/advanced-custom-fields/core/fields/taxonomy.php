...
class acf_field_taxonomy extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'taxonomy';
		$this->label = esc_html__("Taxonomy",'mikos');
	...
	<?php if( $field['field_type'] == 'select' ): ?>
		...
		<select id="<?php echo $field['id']; ?>" name="<?php echo $field['name']; ?>" <?php if( $field['multiple'] ): ?>multiple="multiple" size="5"<?php endif; ?>>
			<?php if( $field['allow_null'] ): ?>
				<option value=""><?php esc_html_e("None", 'mikos'); ?></option>
			<?php endif; ?>
			...
			<?php if( $field['allow_null'] ): ?>
				<li>
					<label class="selectit">
						<input type="<?php echo $field['field_type']; ?>" name="<?php echo $field['name']; ?>" value="" /> <?php esc_html_e("None", 'mikos'); ?>
					</label>
				</li>
			<?php endif; ?>
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php esc_html_e("Taxonomy",'mikos'); ?></label>
	</td>
	<td>
		<?php
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php esc_html_e("Field Type",'mikos'); ?></label>
	</td>
	<td>
		<?php	
		do_action('acf/create_field', array(
			...
			'optgroup' => true,
			'choices' => array(
				esc_html__("Multiple Values",'mikos') => array(
					'checkbox' => esc_html__('Checkbox', 'mikos'),
					'multi_select' => esc_html__('Multi Select', 'mikos')
				),
				esc_html__("Single Value",'mikos') => array(
					'radio' => esc_html__('Radio Buttons', 'mikos'),
					'select' => esc_html__('Select', 'mikos')
				)
			)
		));
		?>
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php esc_html_e("Allow Null?",'mikos'); ?></label>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php esc_html_e("Load & Save Terms to Post",'mikos'); ?></label>
	</td>
	<td>
		<?php	
		do_action('acf/create_field', array(
			...
			'message' => esc_html__("Load value based on the post's terms and update the post's terms on save",'mikos')
		));
		?>
	</td>
</tr>
<tr class="field_option field_option_<?php echo $this->name; ?>">
	...
	<td>
		...
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices'	=> array(
				'object'	=>	esc_html__("Term Object",'mikos'),
				'id'		=>	esc_html__("Term ID",'mikos')
			)
		));
		?>
	</td>
