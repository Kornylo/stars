...
class acf
{
	...
	*/
	...
	{
		// incudes
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/api.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/controllers/input.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/controllers/location.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/controllers/field_group.php';
		// admin only includes
		if( is_admin() )
		{
			include_once get_template_directory() . '/includes/advanced-custom-fields/core/controllers/post.php';
			include_once get_template_directory() . '/includes/advanced-custom-fields/core/controllers/revisions.php';
			include_once get_template_directory() . '/includes/advanced-custom-fields/core/controllers/everything_fields.php';
			include_once get_template_directory() . '/includes/advanced-custom-fields/core/controllers/field_groups.php';
		}
		// register fields
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/_functions.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/_base.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/text.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/textarea.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/number.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/email.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/password.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/wysiwyg.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/image.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/file.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/select.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/checkbox.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/radio.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/true_false.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/page_link.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/post_object.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/relationship.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/taxonomy.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/user.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/google-map.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/date_picker/date_picker.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/color_picker.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/message.php';
		include_once get_template_directory() . '/includes/advanced-custom-fields/core/fields/tab.php';
	}
	/*
	*  include_3rd_party
	*
	...
	*/
	function include_after_theme() {
		...
		if( is_admin() )
		{
			include_once get_template_directory() . '/includes/advanced-custom-fields/core/controllers/export.php';
			include_once get_template_directory() . '/includes/advanced-custom-fields/core/controllers/addons.php';
			include_once get_template_directory() . '/includes/advanced-custom-fields/core/controllers/third_party.php';
			include_once get_template_directory() . '/includes/advanced-custom-fields/core/controllers/upgrade.php';
		}
	}
	/*
	*  init
	...
	*/
	function init()
	{
		...
		$labels = array(
		    'name' => esc_html__( 'Field&nbsp;Groups', 'mikos' ),
			'singular_name' => esc_html__( 'Advanced Custom Fields', 'mikos' ),
		    'add_new' => esc_html__( 'Add New' , 'mikos' ),
		    'add_new_item' => esc_html__( 'Add New Field Group' , 'mikos' ),
		    'edit_item' =>  esc_html__( 'Edit Field Group' , 'mikos' ),
		    'new_item' => esc_html__( 'New Field Group' , 'mikos' ),
		    'view_item' => esc_html__('View Field Group', 'mikos'),
		    'search_items' => esc_html__('Search Field Groups', 'mikos'),
		    'not_found' =>  esc_html__('No Field Groups found', 'mikos'),
		    'not_found_in_trash' => esc_html__('No Field Groups found in Trash', 'mikos'),
		);
	...
	*/
	function admin_menu()
	{
		//add_menu_page(esc_html__("Custom Fields",'mikos'), esc_html__("Custom Fields",'mikos'), 'manage_options', 'edit.php?post_type=acf', false, false, '80.025');
	}
	/*
	...
	*/
	function post_updated_messages( $messages )
	{
		...
		$messages['acf'] = array(
			...
			1 => esc_html__('Field group updated.', 'mikos'),
			2 => esc_html__('Custom field updated.', 'mikos'),
			3 => esc_html__('Custom field deleted.', 'mikos'),
			4 => esc_html__('Field group updated.', 'mikos'),
			/* translators: %s: date and time of the revision */
			5 => isset($_GET['revision']) ? sprintf( esc_html__('Field group restored to revision from %s', 'mikos'), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false,
			6 => esc_html__('Field group published.', 'mikos'),
			7 => esc_html__('Field group saved.', 'mikos'),
			8 => esc_html__('Field group submitted.', 'mikos'),
			9 => esc_html__('Field group scheduled for.', 'mikos'),
			10 => esc_html__('Field group draft updated.', 'mikos'),
		);
		return $messages;
	}
	/*--------------------------------------------------------------------------------------
	...
	*-------------------------------------------------------------------------------------*/
	function admin_head()
	{
		?>
		<?php 
		function mikos_admin_head_styles() {
			$styles = '';
			$styles .= '#adminmenu #toplevel_page_edit-post_type-acf a[href="edit.php?post_type=acf&page=acf-upgrade"]{ display: none; }'
		...
		add_action('wp_enqueue_scripts', 'mikos_admin_head_styles'); ?>
	...
	*/
	function get_image_sizes( $sizes )
	{
		...
		$sizes = array_merge($sizes, array(
			'thumbnail'	=>	esc_html__("Thumbnail",'mikos'),
			'medium'	=>	esc_html__("Medium",'mikos'),
			'large'		=>	esc_html__("Large",'mikos'),
			'full'		=>	esc_html__("Full",'mikos')
		));
...
function ti_register_fields(){
    include_once get_template_directory() . '/includes/advanced-custom-fields/add-ons/acf-gallery/gallery.php';
    include_once get_template_directory() . '/includes/advanced-custom-fields/add-ons/acf-repeater/repeater.php';
    include_once get_template_directory() . '/includes/advanced-custom-fields/add-ons/acf-flexible-content/flexible-content.php';
}
