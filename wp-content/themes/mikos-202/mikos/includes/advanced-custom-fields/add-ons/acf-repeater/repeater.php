...
class acf_field_repeater extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		// vars
		$this->name = 'repeater';
		$this->label = esc_html__("Repeater",'mikos');
...
<tr class="field_option field_option_<?php echo $this->name; ?> field_option_<?php echo $this->name; ?>_fields">
	<td class="label">
		<label><?php esc_html_e("Repeater Fields",'mikos'); ?></label>
	</td>
	<td>
	<div class="repeater">
					...
					<div class="field_form">
						...
						<table class="acf_input widefat">
							<tbody>
								...
								<tr class="field_save">
									<td class="label">
										<!-- <label><?php esc_html_e("Save Field",'mikos'); ?></label> -->
									</td>
									<td>
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php esc_html_e("Minimum Rows",'mikos'); ?></label>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php esc_html_e("Maximum Rows",'mikos'); ?></label>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
...
<tr class="field_option field_option_<?php echo $this->name; ?> field_option_<?php echo $this->name; ?>_layout">
	...
	<td>
		...
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices'	=>	array(
				'table'	=>	esc_html__("Table (default)",'mikos'),
