...
class acf_flexible_content_plugin
{
	...
	*/
	...
	function __construct()
	{
		...
		if( is_admin() )
		{
			...
			{
				include_once get_template_directory() . '/includes/advanced-custom-fields/add-ons/acf-flexible-content/acf-flexible-content/acf-remote-update.php';
			}
	...
	*/
	...
	{
		include_once get_template_directory() . '/includes/advanced-custom-fields/add-ons/acf-flexible-content/acf-flexible-content/flexible-content.php';
	}
