...
class acf_field_flexible_content extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		...
		$this->label = esc_html__("Flexible Content",'mikos');
		$this->category = esc_html__("Layout",'mikos');
	...
	*/
	...
	{
?>
<script type="text/javascript">acf.text.flexible_content_no_fields = "<?php esc_html_e('Flexible Content requires at least 1 layout','mikos'); ?>";</script>
<?php
	}
	...
	*/
	...
	{
		$button_label = ( isset($field['button_label']) && $field['button_label'] != "" ) ? $field['button_label'] : esc_html__("+ Add Row",'mikos');
		$layouts = array();
		...
		<div class="acf_flexible_content">
			...
			<div class="no_value_message" <?php if($field['value']){echo 'style="display:none;"';} ?>>
				<?php printf(esc_html_e("Click the %s button below to start creating your layout",'mikos'), $button_label); ?>
			</div>
	...
	*/
	...
	function create_options( $field )
	{
		...
		$defaults = array(
			'layouts' 		=> array(),
			'button_label'	=>	esc_html__("Add Row",'mikos'),
		);
		...
		foreach($field['layouts'] as $layout_key => $layout):
			...
			$layout['sub_fields'][] = apply_filters('acf/load_field_defaults',  array(
				'key' => 'field_clone',
				'label' => esc_html__("New Field",'mikos'),
				'name' => esc_html__("new_field",'mikos'),
				'type' => 'text',
			));
...
<tr class="field_option field_option_<?php echo $this->name; ?>" data-id="<?php echo $layout_key; ?>">
	<td class="label">
		<label><?php esc_html_e("Layout",'mikos'); ?></label>
		<p class="desription">
			<span><a class="acf_fc_reorder" title="<?php esc_html_e("Reorder Layout",'mikos'); ?>" href="javascript:;"><?php esc_html_e("Reorder",'mikos'); ?></a> | </span>
			<span><a class="acf_fc_delete" title="<?php esc_html_e("Delete Layout",'mikos'); ?>" href="javascript:;"><?php esc_html_e("Delete",'mikos'); ?></a>
			
			<br />
			
			<span><a class="acf_fc_add" title="<?php esc_html_e("Add New Layout",'mikos'); ?>" href="javascript:;"><?php esc_html_e("Add New",'mikos'); ?></a> | </span>
			<span><a class="acf_fc_duplicate" title="<?php esc_html_e("Duplicate Layout",'mikos'); ?>" href="javascript:;"><?php esc_html_e("Duplicate",'mikos'); ?></a></span>
		</p>
	</td>
	<td>
	<div class="repeater">
			...
			<tbody>
				<tr>
					<td class="acf_fc_label" style="padding-left:0;">
						<label><?php esc_html_e('Label','mikos'); ?></label>
						<?php 
					...
					<td class="acf_fc_name">
						<label><?php esc_html_e('Name','mikos'); ?></label>
						<?php 
						do_action('acf/create_field', array(
							'type'	=>	'text',
					...
					<td class="acf_fc_display" style="padding-right:0;">
						<label><?php esc_html_e('Display','mikos'); ?></label>
						<?php 
						do_action('acf/create_field', array(
							'type'	=>	'select',
							...
							'choices'	=>	array(
								'row' => esc_html__("Row",'mikos'),
								'table' => esc_html__("Table",'mikos'),
							)
						));
						?>
					</td>
		...
		<div class="fields_header">
			<table class="acf widefat">
				<thead>
					<tr>
						<th class="field_order"><?php esc_html_e('Field Order','mikos'); ?></th>
						<th class="field_label"><?php esc_html_e('Field Label','mikos'); ?></th>
						<th class="field_name"><?php esc_html_e('Field Name','mikos'); ?></th>
						<th class="field_type"><?php esc_html_e('Field Type','mikos'); ?></th>
					</tr>
				</thead>
			</table>
		</div>
		<div class="fields">
			...
			<div class="no_fields_message" <?php if(count($layout['sub_fields']) > 1){ echo 'style="display:none;"'; } ?>>
				<?php esc_html_e("No fields. Click the \"+ Add Sub Field button\" to create your first field.",'mikos'); ?>
			</div>
					...
					<table class="acf widefat">
						<tr>
							...
							<td class="field_label">
								<strong>
									<a class="acf_edit_field" title="<?php esc_html_e("Edit this Field",'mikos'); ?>" href="javascript:;"><?php echo $sub_field['label']; ?></a>
								</strong>
								<div class="row_options">
									<span><a class="acf_edit_field" title="<?php esc_html_e("Edit this Field",'mikos'); ?>" href="javascript:;"><?php esc_html_e("Edit",'mikos'); ?></a> | </span>
									<span><a title="<?php esc_html_e("Read documentation for this field",'mikos'); ?>" href="http://www.advancedcustomfields.com/docs/field-types/" target="_blank"><?php esc_html_e("Docs",'mikos'); ?></a> | </span>
									<span><a class="acf_duplicate_field" title="<?php esc_html_e("Duplicate this Field",'mikos'); ?>" href="javascript:;"><?php esc_html_e("Duplicate",'mikos'); ?></a> | </span>
									<span><a class="acf_delete_field" title="<?php esc_html_e("Delete this Field",'mikos'); ?>" href="javascript:;"><?php esc_html_e("Delete",'mikos'); ?></a>
								</div>
							</td>
						...
						<table class="acf_input widefat">
							<tbody>
								<tr class="field_label">
									<td class="label">
										<label><span class="required">*</span><?php esc_html_e("Field Label",'mikos'); ?></label>
										<p class="description"><?php esc_html_e("This is the name which will appear on the EDIT page",'mikos'); ?></p>
									</td>
									<td>
										<?php 
										do_action('acf/create_field', array(
								...
								<tr class="field_name">
									<td class="label">
										<label><span class="required">*</span><?php esc_html_e("Field Name",'mikos'); ?></label>
										<p class="description"><?php esc_html_e("Single word, no spaces. Underscores and dashes allowed",'mikos'); ?></p>
									</td>
									<td>
										<?php 
										do_action('acf/create_field', array(
								...
								<tr class="field_type">
									<td class="label"><label><span class="required">*</span><?php esc_html_e("Field Type",'mikos'); ?></label></td>
									<td>
										<?php 
										do_action('acf/create_field', array(
											'type'	=>	'select',
								...
								<tr class="field_instructions">
									<td class="label"><label><?php esc_html_e("Field Instructions",'mikos'); ?></label></td>
									<td>
										<?php
								...
								<tr class="field_column_width">
									<td class="label">
										<label><?php esc_html_e("Column Width",'mikos'); ?></label>
										<p class="description"><?php esc_html_e("Leave blank for auto",'mikos'); ?></p>
									</td>
									<td>
										<?php 
								...
								<tr class="field_save">
									...
									<td>
										<ul class="hl clearfix">
											<li>
												<a class="acf_edit_field acf-button grey" title="<?php esc_html_e("Close Field",'mikos'); ?>" href="javascript:;"><?php esc_html_e("Close Sub Field",'mikos'); ?></a>
											</li>
										</ul>
									</td>
								</tr>								
		...
		<div class="table_footer">
			<div class="order_message"><?php esc_html_e('Drag and drop to reorder','mikos'); ?></div>
			<a href="javascript:;" id="add_field" class="acf-button"><?php esc_html_e('+ Add Sub Field','mikos'); ?></a>
		</div>
	</div>
	</td>
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php esc_html_e("Button Label",'mikos'); ?></label>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
